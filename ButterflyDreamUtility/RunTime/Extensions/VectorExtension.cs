...
namespace ButterflyDreamUtility.Extensions
{
    public static class VectorExtension
    {
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(ref Vector3 value, ref Vector3 min, Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(ref Vector3 value, Vector3 min, ref Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(Vector3 value, ref Vector3 min, ref Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(ref Vector3 value, Vector3 min, Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(Vector3 value, ref Vector3 min, Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector3 Clamp(Vector3 value, Vector3 min, ref Vector3 max)
        {
            return new Vector3(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y), Mathf.Clamp(value.z, min.z, max.z));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(ref Vector2 value, ref Vector2 min, Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(ref Vector2 value, Vector2 min, ref Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(Vector2 value, ref Vector2 min, ref Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(ref Vector2 value, Vector2 min, Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(Vector2 value, ref Vector2 min, Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
        ...
        /// <param name="max">最大値</param>
        /// <returns></returns>
        public static Vector2 Clamp(Vector2 value, Vector2 min, ref Vector2 max)
        {
            return new Vector2(Mathf.Clamp(value.x, min.x, max.x), Mathf.Clamp(value.y, min.y, max.y));
        }
